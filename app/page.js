      ...
      <div className="max-w-5xl mx-auto px-10 py-16" style={{borderTop:'1px solid #1e1e38'}}>
        ...
        {games.length === 0 && (
          <div style={{textAlign:'center', padding:'80px 0'}}>
            ...
            <a href="/login" style={{background:'#00f5a0', color:'black', fontWeight:'bold', fontSize:'12px', letterSpacing:'2px', textTransform:'uppercase', padding:'12px 24px', borderRadius:'8px', textDecoration:'none'}}>
              Sii il primo →
            </a>
          </div>
        )}
